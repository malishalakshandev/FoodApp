...
public class AllOrdersActivity extends AppCompatActivity {
    ...
    public void loadAllOrders(){
        ...
        String url = "http://beezzserver.com/malisha/FoodApp/fa_order/index.php?allorder=A&uid="+user_id;
        ...
        JsonArrayRequest request = new JsonArrayRequest(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(AllOrdersActivity.this, "Error="+error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
        queue.add(request);
    ...
    public void setAllOrders(JSONArray response){
        ...
        try {
            ...
            ListView lv = findViewById(R.id.LV_all_orders);

            //2. Layout file
            int layout = R.layout.single_all_orders;
