...
public class PendingOrdersActivity extends AppCompatActivity {
    ...
    public void loadPendingOrders(){
        ...
        String url = "http://beezzserver.com/malisha/FoodApp/fa_order/index.php?penorder=P&uid="+user_id;
        JsonArrayRequest request = new JsonArrayRequest(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PendingOrdersActivity.this, "Error="+error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
        queue.add(request);
    ...
    public void setPendingOrders(JSONArray response){
        ...
        try {
            ...
            ListView lv = findViewById(R.id.LV_pending_orders);

            //2. Layout file
            int layout = R.layout.single_pending_orders;
